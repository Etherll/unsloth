...
def main() -> int:
    ...
    cases = [
        ...
        {"name": "training-panic-replies-cancel", "state": "training", "trigger": "applescript", "response": "panic", "exit": False,
         "has": ["applicationShouldTerminate LATER start", "prompt training", "response training panic",
